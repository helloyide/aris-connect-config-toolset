...
public class ComponentLineMarkerProvider extends RelatedItemLineMarkerProvider {

    private ComponentLineMarkerVisitor visitor = new ComponentLineMarkerVisitor();
